...
parser = argparse.ArgumentParser(
    description='Find solution for the small time travel problem.',
...
parser.add_argument('-m', '--moves', action='store', type=int,
                    help='Max number of transactions.')
...
parser.add_argument('-o', '--outfile', action='store', type=str,
                    default='./small.txt', help='The file to store the small solution.')
...
if __name__ == '__main__':
    ...
    stock_potential = ut.parse_stock_potential(args.datadir)
