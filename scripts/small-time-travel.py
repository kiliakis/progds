...
from common.utility import read_and_format_input

# python ilp_analysis/ilp_percentiles.py -b results/LOOG-new/csvfiles/kernel-stats-saved_cycles_gtx1080ti_ptx0.22.10.19-11.51.40-merged.csv  -l results/suitability-analysis/csvfiles/kernel-stats-loog_new_inputs_gtx1080ti_ptx0.01.10.19-13.16.48-merged-merged.csv -o results/LOOG-new/plots/ -s -selected
...
parser = argparse.ArgumentParser(
    description='Various plots for the exploitable ILP analysis.',
    usage='{} infile -o outfile'.format(this_filename))

parser.add_argument('-l', '--loogfile', action='store', type=str,
                    help='The input LOOG file that contains the raw counters.')

parser.add_argument('-b', '--basefile', action='store', type=str,
                    help='The input base file that contains the raw counters.')

# parser.add_argument('-t', '--tracefile', action='store', type=str,
#                     help='The ILP trace input file.')
...
parser.add_argument('-yg', '--yamlglobal', type=str,
                    default='{}/configs/plot_config.yml'.format(
                        this_directory),
                    help='The global yaml config file.')

parser.add_argument('-yl', '--yamllocal', type=str,
                    default='{}/configs/{}'.format(this_directory,
